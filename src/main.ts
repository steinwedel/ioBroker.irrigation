...
class Irrigation extends utils.Adapter {
    ...
    private async onReady(): Promise<void> {
        ...
        this.zones = this.config2.zones.map((zoneConfig, index) => new ZoneController(this, index, zoneConfig));
    ...
    private async writeValvesToNative(valves: IValveConfig[]): Promise<void> {
        ...
        if (instanceObj) {
            ...
            (instanceObj.native as unknown as { valves: IValveConfig[] }).valves = valves;
